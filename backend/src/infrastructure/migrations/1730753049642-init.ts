...
export class Init1730753049642 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_exchange_credentials" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" text NOT NULL DEFAULT ('Testnet'), "api_key" varchar NOT NULL, "api_secret" varchar NOT NULL, "exchange" text NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "FK_0b7d13e380462e2bcabd7461028" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`);
