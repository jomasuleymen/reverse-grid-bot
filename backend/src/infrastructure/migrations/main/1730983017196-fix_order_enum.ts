...
export class FixOrderEnum1730983017196 implements MigrationInterface {
    name = 'FixOrderEnum1730983017196'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "IDX_4b8db7e631b6d70e1e5d273336"`);
        await queryRunner.query(`CREATE TABLE "temporary_trading_bot_orders" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "order_id" varchar NOT NULL, "fee_currency" varchar NOT NULL, "custom_id" varchar NOT NULL, "avg_price" real NOT NULL, "quantity" real NOT NULL, "side" varchar CHECK( "side" IN ('buy','sell') ) NOT NULL, "fee" real NOT NULL, "symbol" varchar NOT NULL, "created_date" datetime NOT NULL, "bot_id" integer NOT NULL, CONSTRAINT "FK_4b8db7e631b6d70e1e5d2733363" FOREIGN KEY ("bot_id") REFERENCES "trading_bot" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`);
        await queryRunner.query(`INSERT INTO "temporary_trading_bot_orders"("id", "order_id", "fee_currency", "custom_id", "avg_price", "quantity", "side", "fee", "symbol", "created_date", "bot_id") SELECT "id", "order_id", "fee_currency", "custom_id", "avg_price", "quantity", "side", "fee", "symbol", "created_date", "bot_id" FROM "trading_bot_orders"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "trading_bot_orders"("id", "order_id", "fee_currency", "custom_id", "avg_price", "quantity", "side", "fee", "symbol", "created_date", "bot_id") SELECT "id", "order_id", "fee_currency", "custom_id", "avg_price", "quantity", "side", "fee", "symbol", "created_date", "bot_id" FROM "temporary_trading_bot_orders"`);
