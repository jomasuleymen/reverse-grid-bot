...
export class Init1730746616972 implements MigrationInterface {
    name = 'Init1730746616972'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "exchange_account" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" integer NOT NULL DEFAULT (1), "api_key" varchar NOT NULL, "api_secret" varchar NOT NULL, "exchange" text NOT NULL, "user_id" integer NOT NULL)`);
        await queryRunner.query(`CREATE INDEX "IDX_1aaa1836aabce302a6c84dd10d" ON "exchange_account" ("type") `);
        ...
        await queryRunner.query(`DROP INDEX "IDX_1aaa1836aabce302a6c84dd10d"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_exchange_account" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" integer NOT NULL DEFAULT (1), "api_key" varchar NOT NULL, "api_secret" varchar NOT NULL, "exchange" text NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "FK_967dea913a28a7e58dc2d597b82" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`);
        await queryRunner.query(`INSERT INTO "temporary_exchange_account"("id", "type", "api_key", "api_secret", "exchange", "user_id") SELECT "id", "type", "api_key", "api_secret", "exchange", "user_id" FROM "exchange_account"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "exchange_account" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" integer NOT NULL DEFAULT (1), "api_key" varchar NOT NULL, "api_secret" varchar NOT NULL, "exchange" text NOT NULL, "user_id" integer NOT NULL)`);
        await queryRunner.query(`INSERT INTO "exchange_account"("id", "type", "api_key", "api_secret", "exchange", "user_id") SELECT "id", "type", "api_key", "api_secret", "exchange", "user_id" FROM "temporary_exchange_account"`);
