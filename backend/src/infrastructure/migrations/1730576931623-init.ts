...
export class Init1730576931623 implements MigrationInterface {
    name = 'Init1730576931623'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "trading_bot_config" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "take_profit" real, "grid_step" real, "grid_volume" real, "account_mode" integer NOT NULL DEFAULT (1), "symbol" varchar, "user_id" integer NOT NULL, CONSTRAINT "REL_1ea32e1069f3231dc7e686714d" UNIQUE ("user_id"))`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_trading_bot_config"("id", "take_profit", "grid_step", "grid_volume", "account_mode", "symbol", "user_id") SELECT "id", "take_profit", "grid_step", "grid_volume", "account_mode", "symbol", "user_id" FROM "trading_bot_config"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "trading_bot_config" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "take_profit" real, "grid_step" real, "grid_volume" real, "account_mode" integer NOT NULL DEFAULT (1), "symbol" varchar, "user_id" integer NOT NULL, CONSTRAINT "REL_1ea32e1069f3231dc7e686714d" UNIQUE ("user_id"))`);
        await queryRunner.query(`INSERT INTO "trading_bot_config"("id", "take_profit", "grid_step", "grid_volume", "account_mode", "symbol", "user_id") SELECT "id", "take_profit", "grid_step", "grid_volume", "account_mode", "symbol", "user_id" FROM "temporary_trading_bot_config"`);
