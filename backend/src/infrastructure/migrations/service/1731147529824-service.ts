...
export class Service1731147529824 implements MigrationInterface {
    name = 'Service1731147529824'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_reverse_grid_bot_stats"("id", "buy_count", "sell_count", "open_price", "close_price", "highest_price", "lowest_price", "total_profit", "total_fee", "realized_pn_l", "unrealized_pn_l", "pn_l", "max_pn_l", "created_at", "symbol", "grid_step", "grid_volume", "start_time", "end_time") SELECT "id", "buy_count", "sell_count", "open_price", "close_price", "highest_price", "lowest_price", "total_profit", "total_fee", "realized_pn_l", "unrealized_pn_l", "pn_l", "max_pn_l", "created_at", "symbol", "grid_step", "grid_volume", "start_time", "end_time" FROM "reverse_grid_bot_stats"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "reverse_grid_bot_stats"("id", "buy_count", "sell_count", "open_price", "close_price", "highest_price", "lowest_price", "total_profit", "total_fee", "realized_pn_l", "unrealized_pn_l", "pn_l", "max_pn_l", "created_at", "symbol", "grid_step", "grid_volume", "start_time", "end_time") SELECT "id", "buy_count", "sell_count", "open_price", "close_price", "highest_price", "lowest_price", "total_profit", "total_fee", "realized_pn_l", "unrealized_pn_l", "pn_l", "max_pn_l", "created_at", "symbol", "grid_step", "grid_volume", "start_time", "end_time" FROM "temporary_reverse_grid_bot_stats"`);
