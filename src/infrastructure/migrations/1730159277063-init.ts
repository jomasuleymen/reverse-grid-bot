...
export class Init1730159277063 implements MigrationInterface {
    name = 'Init1730159277063'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "trading_bot_config" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "close_at_price" integer, "user_id" integer, CONSTRAINT "REL_1ea32e1069f3231dc7e686714d" UNIQUE ("user_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_trading_bot_config" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "close_at_price" integer, "user_id" integer, CONSTRAINT "REL_1ea32e1069f3231dc7e686714d" UNIQUE ("user_id"), CONSTRAINT "FK_1ea32e1069f3231dc7e686714d2" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`);
